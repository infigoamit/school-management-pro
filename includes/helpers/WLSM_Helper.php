...
class WLSM_Helper {
	...
	public static function search_field_list() {
		return array(
			...
			'father_name'       => esc_html__( 'Father Name', 'school-management' ),
			'father_phone'      => esc_html__( 'Father Phone', 'school-management' ),
	...
	public static function fee_period_list() {
		return array(
			...
			'quaterly'    => esc_html__( 'Quaterly (Termly)', 'school-management' ),
			'half-yearly' => esc_html__( 'Half Yearly (Termly)', 'school-management' ),
