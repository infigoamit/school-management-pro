...
<div class="wrap license-container">
	<div class="top_head">
		...
		<div class="column-9">
			...
			<p class="license_info"><?php esc_html_e( "Please activate this plugin with a license key. If you don’t have a license yet, you can purchase it from ", 'school-management' ); ?>
				<a href="https://weblizar.com/amember/signup/school-management" target="_blank"><?php esc_html_e( 'here', 'school-management' ); ?></a>
			</p>
		</div>
	</div>
	...
	<div class="license-section">
		...
		if ( isset( $_POST['key'] ) && ! empty( $_POST['key'] ) ) {
			...
			$wlsm_lm->error_message = esc_html__( "Get Your License Key", 'school-management' ) . ' ' . '<a target="_blank" href="https://weblizar.com/amember/softsale/license">' . esc_html__( "Click Here", 'school-management' ) . '</a>';
		} ?>
			<div class="column-6">
		<?php
		if( $validated ) {
