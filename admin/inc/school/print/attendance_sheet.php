			...
			<table class="table table-bordered wlsm-view-students-attendance-table">
				<thead>
					<tr class="bg-primary text-white">
						...
						<?php } ?>
						<th class="wlsm-attendance-count"><?php esc_html_e( 'Total Attendance', 'school-management' ); ?></th>
						<th class="wlsm-present-count"><?php esc_html_e( 'Total Present', 'school-management' ); ?></th>
						<th class="wlsm-absent-count"><?php esc_html_e( 'Total Absent', 'school-management' ); ?></th>
					</tr>
				</thead>
				<tbody>
					<?php
					...
					<tr>
						...
						<td>
							...
							if ( ! $status ) {
								...
								$total_present++;
							?>
							<span class="text-success wlsm-font-bold"><?php echo esc_html( $status ); ?></span>
							<?php
							}
							else {
								$total_absent++;
							?>
							<span class="text-danger wlsm-font-bold"><?php echo esc_html( $status ); ?></span>
							<?php
							}
							?>
						</td>
