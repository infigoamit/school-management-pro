		...
		<div class="mt-2 text-center wlsm-section-heading-block">
			...
			<span class="float-md-right">
				<a href="<?php echo esc_url( $page_url . '&action=save' ); ?>" class="btn btn-sm btn-outline-light">
					...
					<?php echo esc_html( 'Take Attendance', 'school-management' ); ?>
				</a>
			</span>
		</div>
		...
		<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" id="wlsm-view-attendance-form">
			...
			<div class="row mt-2">
				<div class="col-md-12 text-center">
					<button type="button" class="btn btn-sm btn-primary" id="wlsm-view-attendance-btn" data-nonce="<?php echo esc_attr( wp_create_nonce( 'view-attendance' ) ); ?>">
						<?php esc_html_e( 'View Attendance', 'school-management' ); ?>
					</button>
				</div>
			</div>
