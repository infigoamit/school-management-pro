	...
	<div class="col-md-12">
		<div class="text-center wlsm-section-heading-block">
			<span class="wlsm-section-heading">
				...
				<?php esc_html_e( 'Student Fee Invoices', 'school-management' ); ?>
			</span>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="h6 text-secondary wlsm-font-bold">
									<span class="border-bottom"><?php esc_html_e( 'Search Fee Invoices', 'school-management' ); ?></span>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-md-8 mb-1">
									<div class="h6">
										...
										<?php esc_html_e( 'Search Fee Invoice By Keyword', 'school-management' ); ?>
										</span>
									</div>
								</div>
							</div>
						...
						<div class="wlsm-search-students wlsm-search-class-students pt-2">
							<div class="row">
								<div class="col-md-8 mb-1">
									<div class="h6">
										<span class="text-secondary border-bottom">
										<?php esc_html_e( 'Search Fee Invoice By Class', 'school-management' ); ?>
										</span>
									</div>
								</div>
							</div>
						...
						<div class="form-row">
							<div class="col-md-12">
								<button type="button" class="btn btn-sm btn-outline-primary" id="wlsm-get-invoices-btn">
									<i class="fas fa-file-invoice"></i>&nbsp;
									<?php esc_html_e( 'Get Invoices!', 'school-management' ); ?>
								</button>
							</div>
						</div>
					</form>
						...
						<ul class="list-group list-group-flush">
							...
							<li class="list-group-item">
								<span class="wlsm-font-bold">
									<?php esc_html_e( 'Payment Received', 'school-management' ); ?>:
								</span>
							...
							<li class="list-group-item">
								<span class="wlsm-font-bold">
									<?php esc_html_e( 'Amount Pending', 'school-management' ); ?>:
								</span>
			...
			<table class="table table-hover table-bordered" id="wlsm-staff-invoices-table">
				<thead>
					<tr class="text-white bg-primary">
						...
						<th scope="col"><?php esc_html_e( 'Invoice Title', 'school-management' ); ?></th>
