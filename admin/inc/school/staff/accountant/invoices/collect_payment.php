		...
		<div class="mt-3 text-center wlsm-section-heading-block">
				...
				<span class="wlsm-section-heading">
					...
					printf(
						wp_kses(
							...
							__( 'Collect Payment For Invoice: %1$s (%2$s)', 'school-management' ),
							array(
			...
			<span class="float-md-right">
				<a href="<?php echo esc_url( $page_url ); ?>" class="btn btn-sm btn-outline-light">
					...
					<?php esc_html_e( 'View All Invoices', 'school-management' ); ?>
				</a>
			</span>
		</div>
			...
			<div class="row">
				<div class="col-md-6">
					<ul class="list-group list-group-flush">
						...
						<li class="list-group-item">
							<span class="wlsm-font-bold"><?php esc_html_e( 'Amount', 'school-management' ); ?>:</span>
							<span><?php echo esc_html( WLSM_Config::get_money_text( $invoice_amount ) ); ?></span>
						</li>
						<li class="list-group-item">
							<span class="wlsm-font-bold"><?php esc_html_e( 'Discount', 'school-management' ); ?>:</span>
							<span><?php echo esc_html( WLSM_Config::get_money_text( $invoice_discount ) ); ?></span>
						</li>
						<li class="list-group-item">
							<span class="wlsm-font-bold"><?php esc_html_e( 'Allow Partial Payments', 'school-management' ); ?>:</span>
		...
		<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" id="wlsm-collect-invoice-payment-form">
			...
			<div class="row mt-2 mb-2">
				<div class="col-md-12 text-center">
					<button type="submit" class="btn btn-primary" id="wlsm-collect-invoice-payment-btn" data-message-title="<?php esc_attr_e( 'Confirm Payment!', 'school-management' ); ?>" data-message-content="<?php esc_attr_e( 'Are you sure to add this payment?', 'school-management' ); ?>">
