					...
					<?php } else { ?>
						<div class="col-md-6">
							<div class="form-group">
								...
								<select name="student_admit_card_id" class="form-control selectpicker" id="wlsm_student" data-live-search="true" data-none-selected-text="<?php esc_attr_e('Select Student', 'school-management'); ?>">
									<option value=""></option>
									<?php
