			...
			<div class="wlsm-form-section">
				...
				<div class="form-row">
					<div class="form-group col-md-6">
						...
						<p><?php esc_html_e( 'You can assign create this exam for single class or multiple classes. You will be able to create admit cards for selected students from these classes.', 'school-management' ); ?></p>
					</div>
					<div class="form-group col-md-6">
						<label for="wlsm_exam_group" class="wlsm-font-bold">
							<?php esc_html_e( 'Exam Group', 'school-management' ); ?>:
						</label>
						<input type="text" name="exam_group" class="form-control" id="wlsm_exam_group" placeholder="<?php esc_attr_e( 'Enter exam group', 'school-management' ); ?>" value="<?php echo esc_attr( stripslashes( $exam_group ) ); ?>">
